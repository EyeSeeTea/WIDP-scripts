#dev
#backup_db_dev.sh DAILY --format custom --destination GVA11SUDRATINI.who.int  >> /home/tomcatuser/backups/logs/db_backups.log 2>&1
#backup_db_dev.sh WEEKLY --format custom --destination GVA11SUDRATINI.who.int >> /home/tomcatuser/backups/logs/db_backups.log 2>&1
#backup_db_dev.sh MONTHLY --format custom --destination GVA11SUDRATINI.who.int >> /home/tomcatuser/backups/logs/db_backups.log 2>&1
#BACKUP-DEV-DAILY_cformat.dump
#BACKUP-DEV-WEEKLY_cformat.dump
#BACKUP-DEV-MONTHLY_cformat.dump
